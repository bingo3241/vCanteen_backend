...
async function insertNewVendor(email, password, account_type, restaurant_name, phone_number, four_digit_pin, firebase_token) {
    ...
    try{
        await db.query("INSERT INTO Vendors(email, passwd, account_type, restaurant_name, vendor_image, phone_number, four_digit_pin, token_firebase) VALUES (?,?,?,?,?,?,?,?) ", [email, password, account_type, restaurant_name, vendor_image, phone_number, four_digit_pin, firebase_token])
