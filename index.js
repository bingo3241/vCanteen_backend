...
app.post("/testfirebase", async (req, res) => {
  let {test, testmsg} = req.body
  x = await sendToFirebase(test, testmsg, "c3C4HMciEdk:APA91bEJ4nxs0vX0lRgudTfQNXPSfPoKDyQsi7VS4EBBkvJ7nR5SphZzp5TjPiRn4Va_s3aAQ92JViBkPKEN10IXrCz9M3v9pufjzwCw22CDnJuA6HRXaNbCNazOnjiU9xzuGIn_BiHV")
  res.status(200).send()
})
